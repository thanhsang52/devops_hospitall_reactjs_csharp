...
export const API_BASE_URL = "http://146.190.108.212:5000/api";
...
export const updateMedicalRecord = (id, data) =>
  api.put(`/medicalrecords/${id}`, data);
export const deleteMedicalRecord = (id) => api.delete(`/medicalrecords/${id}`);

// Invoice
export const createInvoiced = (data) =>
  api.post("/Invoices/createddetails", data);
export const getInvoicesByPatientId = (patientId) =>
  api.get(`/Invoices/by-patient/${patientId}`);
...
export const updateWaitingList = (id, data) =>
  api.put(`/WaitingList/${id}`, data);
...
export const getPrescriptionDetailById = (id) =>
  api.get(`/prescriptiondetails/${id}`);
export const createPrescriptionDetail = (data) =>
  api.post("/prescriptiondetails", data);
export const updatePrescriptionDetail = (id, data) =>
  api.put(`/prescriptiondetails/${id}`, data);
export const deletePrescriptionDetail = (id) =>
  api.delete(`/prescriptiondetails/${id}`);
